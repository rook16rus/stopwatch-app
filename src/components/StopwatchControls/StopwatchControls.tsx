...
const StopwatchControls = () => {
    return (
        <div className={styles.controls}>
            <button className={`${styles.controls__button} ${styles.controls__stop}`}>
                <img src={stop} alt="Иконка стоп"/>
            </button>
            <button className={`${styles.controls__button} ${styles.controls__pause}`}>
                <img src={pause} alt="Иконка стоп"/>
            </button>
            <button className={`${styles.controls__button} ${styles.controls__next}`}>
